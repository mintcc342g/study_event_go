...
func (sq *SkillQuery) FirstID(ctx context.Context) (id types.SkillID, err error) {
	var ids []types.SkillID
...
func (sq *SkillQuery) FirstIDX(ctx context.Context) types.SkillID {
...
func (sq *SkillQuery) OnlyID(ctx context.Context) (id types.SkillID, err error) {
	var ids []types.SkillID
...
func (sq *SkillQuery) OnlyIDX(ctx context.Context) types.SkillID {
...
func (sq *SkillQuery) IDs(ctx context.Context) ([]types.SkillID, error) {
	var ids []types.SkillID
...
func (sq *SkillQuery) IDsX(ctx context.Context) []types.SkillID {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
