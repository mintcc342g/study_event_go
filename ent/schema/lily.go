...
func (Lily) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Uint32("deletion_reason").GoType(types.DeletionReason(0)).Default(0),
		field.String("first_name").NotEmpty(),
		field.String("middle_name"),
		field.String("last_name").NotEmpty(),
		field.Uint32("rank").Default(0),
		field.Uint64("main_charm_id").GoType(types.CharmID(0)).Default(0),
		field.Uint64("sub_charm_id").GoType(types.CharmID(0)).Default(0),
