...
func ID(id types.SkillID) predicate.Skill {
...
func IDEQ(id types.SkillID) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id types.SkillID) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func IDIn(ids ...types.SkillID) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func IDNotIn(ids ...types.SkillID) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id types.SkillID) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func IDGTE(id types.SkillID) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func IDLT(id types.SkillID) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func IDLTE(id types.SkillID) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func Type(v types.SkillType) predicate.Skill {
	vc := uint32(v)
	return predicate.Skill(func(s *sql.Selector) {
...
func TypeEQ(v types.SkillType) predicate.Skill {
	vc := uint32(v)
	return predicate.Skill(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldType), vc))
	})
...
func TypeNEQ(v types.SkillType) predicate.Skill {
	vc := uint32(v)
	return predicate.Skill(func(s *sql.Selector) {
...
func TypeIn(vs ...types.SkillType) predicate.Skill {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = uint32(vs[i])
	}
...
func TypeNotIn(vs ...types.SkillType) predicate.Skill {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = uint32(vs[i])
	}
...
func TypeGT(v types.SkillType) predicate.Skill {
	vc := uint32(v)
	return predicate.Skill(func(s *sql.Selector) {
...
func TypeGTE(v types.SkillType) predicate.Skill {
	vc := uint32(v)
	return predicate.Skill(func(s *sql.Selector) {
...
func TypeLT(v types.SkillType) predicate.Skill {
	vc := uint32(v)
	return predicate.Skill(func(s *sql.Selector) {
...
func TypeLTE(v types.SkillType) predicate.Skill {
	vc := uint32(v)
	return predicate.Skill(func(s *sql.Selector) {
